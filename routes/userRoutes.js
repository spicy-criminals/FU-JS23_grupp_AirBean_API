...
Med dessa ändringar bör både inloggningen och tokenautentiseringen fungera korrekt. Kom ihåg att testa rutter som kräver autentisering genom att inkludera rätt JWT-token i begäran.
...
// Använd tokenautentisering för att skydda vissa rutter
router.get("/protectedRoute", authenticate, (req, res) => {
  res.status(200).send("Du har åtkomst till skyddad information.");
});
